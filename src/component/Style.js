        ...
        return (
            ...
            <div className="form-row">
                <div className="form-group col-sm-6">
                    ...
                    <select value={this.props.Social.signatureStyle} className="form-control" ref={(input) => this.signatureStyle  = input} onChange={(e) => this.handleChange(e)} name="signatureStyle" defaultValue="3">
                ...
                <div className="form-group col-sm-6">
                    ...
                    <input className="form-control" type="color" defaultValue="#450877" ref={(input) => this.feactureColor  = input} onChange={(e) => this.handleChange(e)} name="feactureColor"/>
                </div>
                <div className="form-group col-sm-6">
                    <label htmlFor="linkcolor">Link Color</label>
                    <input className="form-control" type="color" defaultValue="#000000" ref={(input) => this.linkcolor  = input} onChange={(e) => this.handleChange(e)} name="linkcolor"/>
                </div>
                <div className="form-group col-sm-6">
                ...
                <div className="form-group col-sm-6">
                    <label htmlFor="fontSize">Default Size</label>
                    <select className="form-control" ref={(input) => this.fontSize  = input} onChange={(e) => this.handleChange(e)} name="fontSize" defaultValue="1rem">
